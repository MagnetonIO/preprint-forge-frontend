...
interface PaperListProps {
  papers?: { papers: PaperInfo[]; total: number } | null
...
export function PaperList({ papers, onPaperDeleted }: PaperListProps) {
  ...
  // Access the papers array safely from the response object
  ...
  return (
    <div className="w-80 border-r bg-muted/10">
      <div className="p-4 font-semibold">Generated Papers ({totalCount})</div>
